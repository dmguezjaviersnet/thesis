...
\section{Los modelos de aprendizaje de máquinas}
	...
	\subsection{Estructura del juego de datos y características escogidas}
		Con el juego de datos cargado ya en el programa, se construyó un \textbf{DataFrame} de la biblioteca \textbf{pandas} donde cada columna representa una
		característica y cada fila uno de los datos recopilados. Entre las columnas de este \textbf{DataFrame} están los valores de los 3 ejes del \textbf
		...
		que fueron mencionadas en el capítulo anterior (ver capítulo \ref{chapter:proposal}), son computadas y agregadas como columnas al \textbf{DataFrame}.
