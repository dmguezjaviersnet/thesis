...
\section{Resultados}
	...
	En la segunda fase del \emph{pipeline}, la selección de características, se pudo apreciar en la tabla \ref{table:13} que los features más
	escogidos por los algoritmos de selección de características fueron fulanito, menganito, ciclanito, etc. 

	Finalmente en la fase final del \emph{pipeline}, los modelos supervisados, se pudo observar que ...
