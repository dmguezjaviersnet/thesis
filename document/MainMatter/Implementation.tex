...
\section{Resultados}
	...
	Dados los resultados obtenidos, la configuración con la cual se obtubo mejores resultado utilizó \textbf{DBSCAN} para detectar las anomalías y como modelo
