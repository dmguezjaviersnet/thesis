...
\section{Resultados}
	...
	\begin{table}
		\centering
		\caption{Resultados usando Z-Thresh como método de detección de anomalías}
		\label{table:13}
		\begin{tabular}{lcccc}
		\toprule
	...
	\begin{table}[htb]
		\centering
		\caption{Resultados usando Z-Diff como método de detección de anomalías}
		\label{table:14}
		\begin{tabular}{lcccc}
		\toprule
				Model &  Accuracy &  F1 Score &  Precision &  Recall \\
	...
	\begin{table}
		\centering
		\caption{Resultados usando DBSCAN como método de detección de anomalías}
		\label{table:15}
		\begin{tabular}{lcccc}
		\toprule
				Model &  Accuracy &  F1 Score &  Precision &  Recall \\
	...
	\begin{table}
		\centering
		\caption{Resultados usando One Class SVM como método de detección de anomalías}
		\label{table:16}
		\begin{tabular}{lcccc}
		\toprule
				Model &  Accuracy &  F1 Score &  Precision &  Recall \\
