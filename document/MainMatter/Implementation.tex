...
\section{Los juegos de datos}   
	...
	\subsection{Detalles acerca de algunos de los baches marcados}
		...
		son idénticas a un bache, como por ejemplo, una boca de alcantarilla hundida en el pavimento (ver \ref{fig:14}), que en condiciones normales no 
		tendría las mismas características (ver \ref{fig:15}). A pesar de que ambas son tapas de alcantarilla, en el primer caso las lecturas de los 
		...
		a las de un bache como se muestra en la figura \ref{fig:17}.
		...
		pueden apreciar en las figuras \ref{fig:18} y \ref{fig:19}, que sí son realmente baches.
...
\section{Resultados}
	...
	Las configuraciones con las que se alcanzaron estas puntuaciones se pueden ver en detalle en las las tablas \ref{table:17}-\ref{table:36}.
