...
bache. Para ello suelen utilizar técnicas de procesamiento de imágenes o de aprendizaje de máquinas. Otros proponen resolverlo utilizando métodos heurísticos
o de aprendizaje de máquinas, que hacen uso de la serie temporal generada a partir del muestreo de sensores como puede ser el acelerómetro. 
...
que son baches dentro de una imagen.
	...
	\subsection{Detección usando técnicas de procesamiento de imágenes}
		...
		el punto central, y el \emph{convex hull} son necesarios para decicidir si varias regiones candidatas incompletas tales como, sombras, manchas y
