...
de \emph{deep learning}, una red neuronal convolucional(\textbf{CNN}).Con el uso de un modelo de \textbf{CNN} se logra  
...
con 5 \emph{backbones} diferentes (\textbf{ResNet50}, \textbf{VGG16}, \textbf{MobileNetV2}, \textbf{InceptionV3}  y  \emph{CNN} 
propuesta llamada  \textbf{MVGG16}). La propuesta  \emph{Faster R-CNN} con \emph{backbone} \textbf{MVGG16} desarrolló una 
\emph{CNN} profunda con diferentes capas \emph{dilated} para aumentar los campos receptivos.
