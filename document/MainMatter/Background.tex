...
Ryu et al. ~\brackcite{ryu2015image} 
...
\section{Detección utilizando series temporales de otros sensores}
	...
	\subsection{Enfoques utilizando \emph{Machine Learning}}
		\subsubsection{Algoritmos}
			...
			{kulkarni2014pothole, pawar2020efficient, gonzalez2017learning}. \brackcite{zheng2020fused} agregan a este proceso textbf{DTW}(\emph{
		...
		\subsubsection{Features}
			...
			pawar2020efficient}, incluso \textbf{características} como cuantas veces cierto \textbf{característica} estadístico sobrepasó cierto \textbf{umbral}
		...
		\subsubsection{Etiquetado de los datos}
			...
			{el2018towards}. \brackcite{gonzalez2017learning} etiquetaron las anomalías de la siguiente forma, cuando se van acercando a la anomalía
			...
			serie temporal. \brackcite{tai2010automatic} etiquetaron sus datos realizando grabaciones de audio durante el viaje recolectando la voz 
