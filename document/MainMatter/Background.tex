...
que son baches dentro de una imagen.
	...
	\subsection{Detección usando técnicas de procesamiento de imágenes}
		...
		Ryu et al.\brackcite{ryu2015image}, por su parte, dan una propuesta para decidir si las regiones candidatas refinadas son baches o no. Con este fin, 
		...
		La propuesta de Buza et al.\brackcite{buza2013pothole} consiste en aplicar un proceso de selección de semillas. Esto marcará el área para la identificación 
	...
	Pereira et al.\brackcite{pereira2018deep} proponen una \textbf{CNN} con cuatro capas de \emph{convolution} , cuatro
	...
	% Las salidas de las capas de \emph{fully-connected} están conectadas a la capa de salida que hace 
	% clasificación binaria con una neurona. 
	% La última capa \emph{fully-connected} da la clasificación para la clase de las imágenes de entrada.
	...
	se realizaron desde distintas cámaras, ángulos de disparo, tamaños, número de baches y fondos\brackcite{akagic2017pothole,pereira2018deep,
	ahmed2021smart}. Un conjunto de datos no estructurados se puede utilizar para examinar el verdadero potencial de cualquier método de 
	...
	Ahmed et al.\brackcite{ahmed2021smart} usan un conjunto de datos que incluye imágenes de baches que se recopilaron en diferentes condiciones de luz 
