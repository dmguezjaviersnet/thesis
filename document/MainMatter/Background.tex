...
\section{Detección utilizando series temporales}
	Otro alternativa común para determinar la presencia de baches en la carretera, se basa en la utilización de series temporales que se generan como resultado del muestre
	de sensores como el acelerómetro o el giroscopio. Para determinar la existencia de los baches, los primeros trabajo se basaron en el uso de técnicas de establecimiento
	de umbrales. Para ello existen diferentes enfoques.
	...
	\subsection{Enfoques utilizando aprendizaje de máquinas}
		\subsubsection{Algoritmos}
			...
			supervisados más utilizados están \emph{Support Vector Machines}(\textbf{SVM})\brackcite{tai2010automatic, ranjith2015anomaly, carlos2018evaluation,
		...
		\subsubsection{Selección y extracción de características}
			...
			pawar2020efficient}. De los valores del \textbf{acelerómetro} se extraen también otras características basadas en ideas planteadas en los primeros
			...
			cierta característica estadística sobrepasó cierto umbral establecido\brackcite{carlos2018evaluation}.\\
			...
			la Transformada Rápida de Fourier(\textbf{FFT}) como frecuencia media, mediana de la frecuencia y energía de las bandas de frecuencia\brackcite{seraj2015roads,
			perttunen2011distributed}. Otros proponen extraer dichas características utilizando \emph{Wavelet Decomposition} específicamente \emph{Stationary Wavelet
			...
			segmentos de carretera. Para ello utilizan algún proceso de selección de características como \emph{Forward Selection}, \emph{Backward Selection}
	...
	\subsection{Purificación y segmentación de la señal}
		...
		{seraj2015roads}, y \emph{high-pass filters} y \emph{low-pass filters}\brackcite{eriksson2008pothole, kulkarni2014pothole} se utilizan para eliminar
	...
	\subsection{Ubicación del dispositivo en el vehículo}
		Primero, antes de poder atacar este problema utilizando alguna propuesta que utilice datos de sensores como el \textbf{acelerómetro}, el \textbf{giroscopio}
		y el \textbf{GPS}, es necesario llevar a cabo un trabajo de campo que permita recopilar información utilzando estos sensores. Así estén separados cada uno,
		o utilizando algún dispositivo móvil que los tenga incorporados.

		Debido a que estos dispositivos tienen los 3 ejes prefijados, es necesario colocarlos de tal manera que los datos recopilados tengan sentido, o sea,
		...
		\brackcite{astarita2012mobile}. Algunos autores colocaron el dispositivo en el parabrisas\brackcite
...
\section{Consideraciones sobre el estado del arte}
	...
	fin de llegar a una alternativa de solución. Se utilizará el enfoque basado series temporales generadas a partir del muestreo de sensores como el
	\textbf{acelerómetro}, \textbf {giroscopio} y el \textbf{GPS}. La posición del dispositivo se decidió que fuera fija, de forma que su orientación
	...
	El proceso de etiquetado se realizó de forma manual, aunque no utilizando vídeo ni audio, sino buscando en un radio determinado alrededor de cada
