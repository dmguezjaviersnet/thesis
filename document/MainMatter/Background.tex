...
Un recortamiento de las imágenes de entrada a un cierto tamaño reduce la complejidad computacional ~\brackcite{jo2015pothole}. 
...
reconocimiento ~\brackcite{buza2013pothole}.
...
\section{Detección utilizando series temporales de otros sensores}
	...
	\subsection{Los trabajos seminales}
		Entre los varios métodos heurísticos ~\textcite{mednis2011real} propusieron los siguientes:\\
	...
	\subsection{Enfoques utilizando \emph{Machine Learning}}
		...
		Con respecto a los trabajos existentes que utilizan el aprendizaje de máquinas existen varios, ~\brackcite{carlos2018evaluation} además
		...
		El algoritmo para la detección de anomalías en la carretera propuesto por ~\brackcite{eriksson2008pothole} se basa en que condiciones
		...
		de lecturas del acelerómetro es bastante complelejo debido a la amplia variación en las condiciones de la carretera y el comportamiento
		...
		frena de manera repentina. Los datos recopilados son divididos en 256 ventanas pues los eventos que interesan son generalmente eventos de
		corta duración. Una serie de filtros de procesamientos de señales son aplicados al  pedazo continuo de ventanas, donde cada filtro está
		diseñado para rechazar uno o más de un evento que no sea bache. Las etapas de filtrado se dividen en 5 y son las siguientes:
		...
		alguno de los \emph{threshold}s y el último instante, y utilizan un método para encontrar los instantes de tiempo justo antes de que ocurriera
