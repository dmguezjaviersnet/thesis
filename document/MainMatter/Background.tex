...
Entre los varios métodos estadísticos ~\brackcite{mednis2011real} propusieron los siguientes:\\
...
~\brackcite{mohan2008nericell} para el diseño de su estrategia se basaron en 2 ideas, cuando un vehículo interactúa con una
...
Con respecto a los trabajos existentes que utilizan el aprendizaje de máquinas existen varios, ~\brackcite{carlos2018evaluation} además de realizar
...
un cierto valor \emph{threshold}. Esta idea fue tomada teniendo en cuenta una serie de artículos con respecto al tema(~\brackcite{mednis2011real}), con el
...
~\brackcite{seraj2015roads} en su propuesta, incorporaron además los datos del giroscopio con el objetivo de obtener más \emph{features} que permitieran mejorar
...
~\brackcite{el2018towards} como en el artículo previamente mencionado, llevaron a cabo un extenso proceso, separando las señales de los sensores por
...
El algoritmo para la detección de anomalías en la carretera propuesto por ~\brackcite{eriksson2008pothole} se basa en que condiciones anómalas de la carretera
...
~\brackcite{cong2013applying} para la extracción de \emph{features} descomponen la señal usando \textbf{WPD}(\emph{Wavelet Packet Decomposition}) usando
...
~\brackcite{kulkarni2014pothole} proponen un sistema que detecta los baches, registra su ubicación, un crea un documento que
...
~\brackcite{zheng2020fused} se refieren a que la mayoría de los artículos con respecto al tema no toman en consideración el hecho que la gran mayoría de la
...
~\brackcite{perttunen2011distributed} explican que los sensores del teléfono móvil son reflejados en las señales de dos maneras: Primero, la señal del
