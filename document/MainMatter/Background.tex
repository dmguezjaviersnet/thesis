...
procesamiento de imágenes digitales. La mayoría propone tres pasos fundamentales. Primero, un preprocesamiento de la imagen utilizando
principalmente un proceso de segmentación. Luego se encargan de busar la región de interés que representa los posibles baches en la imagen.
Y por último, tratan identificar si esa región de interés es un efecto un bache o no. 
	...
	\subsection{Detección usando técnicas de procesamiento de imágenes}
		...
		{koch2011pothole, jo2015pothole,ryu2015image}. En el \emph{histogram shape-based thresholding} el valor T de umbral se determina como el valor de
