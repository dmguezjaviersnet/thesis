...
\section{Detección utilizando series temporales}
	...
	\subsection{Ubicación del dispositivo en el vehículo}
		...
		y el \textbf{GPS}, es necesario llevar a cabo un trabajo de campo que permita recopilar información utilizando estos sensores. Así estén separados cada uno,
...
\section{Consideraciones sobre el estado del arte}
	...
	fin de llegar a una alternativa de solución. Se utilizará el enfoque basado en series temporales generadas a partir del muestreo de sensores como el
