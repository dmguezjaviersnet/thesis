...
\section{Detección utilizando series temporales de otros sensores}
	...
	\subsection{Enfoques utilizando \emph{Machine Learning}}
		...
		\subsubsection{Selección y extracción de características}
			...
			o \emph{Principal Components Analysis}(\textbf{PCA}) \brackcite {cong2013applying}. \emph{Gonzales et al.} \brackcite{gonzalez2017learning}
	...
	\subsection{Geolocalización del bache utilizando GPS}
		...
		% espejos en cuadratura y seguido por submuestreo. La selección de características basadas en \emph{Machine Learning} puede ser asistida para
