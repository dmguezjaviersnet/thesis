...
\section{Etiquetado de anomalías}
	...
	que anomalías que no sean baches sean etiquetadas como tal, debido a que existe un bache en un radio cercano a esta.
...
\section{Selección de modelo}
	...
	modelo. La métrica de evaluación que se escogió fue el \emph{F1 score}, porque se consideró que un equilibrio entre \emph{precision} y el
	...
	\textbf{SVM}. Junto con este proceso de selección de modelo también se llevó a cabo una selección de hiperparámetros que permita determinar con
