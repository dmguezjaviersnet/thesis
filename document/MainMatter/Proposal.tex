...
\section*{Captura de señales}
	...
	El \textbf{GPS} es el sensor que le permite al dispositivo móvil ubicarse sobre la superficie de la tierra utilizando 
	...
	%------------------------- Detallar las frecuencias de muestreo según la velocidad ---------------------------
...
\section*{Detección de outliers}
	...
	%Poner los hiperparámetros seleccionadas para cada uno de los métodos.
