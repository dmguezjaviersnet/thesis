...
\section{Detección de anomalías}
	Los baches no son más que anomalías en la carretera. Teniendo en cuenta esto, se propuso detetar dichar anomalías utilizando
	...
	pues se consideró que las lecturas de este último sensor pueden ser significativas a la hora de determinar la existencia de una 
