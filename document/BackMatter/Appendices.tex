\begin{appendices}
	...
	\section*{Tablas con los hiperparámetros que se probaron los métodos supervisados}
		...
		Si \textbf{max\_depth} es None los nodos se expanden hasta que todas las hojas sean puras o hasta que todas 
		las hojas contengan menos de \textbf{min\_samples\_split} \emph{samples}.\\

		Si \textbf{max\_features} es None  entonces  \textbf{max\_features=n\_features}.
