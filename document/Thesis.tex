...
\title{Sistema para la detección automática de baches en la carretera}
\author{\\\vspace{0.25cm}Javier E. Domínguez Hernández\\\vspace{0.2cm} David Orlando De Quesada Oliva}
\advisor{\\\vspace{0.25cm}Dr. Yudivián Almeida\\\vspace{0.2cm} Lic. Carlos Bermudez Porto}
\degree{Licenciado en Ciencia de la Computación}
\faculty{Facultad de Matemática y Computación}
\date{Fecha\\\vspace{0.25cm} Noviembre, 2022}
